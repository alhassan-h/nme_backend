...
heroku config:set FRONTEND_URL="https://nme-230619.vercel.app" --app $HEROKU_APP
...
# CORS settings
heroku config:set CORS_ALLOWED_ORIGINS=https://nme-230619.vercel.app,https://nme-frontend-app-afc4f6bdf45f.herokuapp.com,http://localhost:3000 --app $HEROKU_APP

# Mail settings
heroku config:set MAIL_MAILER=mailgun --app $HEROKU_APP
heroku config:set MAIL_MAILER_MAILGUN_DOMAIN=DOMAIN --app $HEROKU_APP
heroku config:set MAIL_MAILER_MAILGUN_SECRET=SECRET --app $HEROKU_APP
